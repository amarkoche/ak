...
// error values
$fnameErr = $lnameErr =  $emailErr = $phoneErr = $serviceErr = $messageErr = "";
...
if (empty($_POST["service"])) {
    ...
    $allowed_services = ["IT_Consulting", "Finance_Consulting", "Business_Consulting", "Legal_Consulting"];
...
<form class="getintouch free-consulting-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?># target" method="post">
    <div class="row">
        <h4 class=""> Free Consulting </h4>
        <p class="h6">Receive tailored solutions, expert advice, and precise estimates.</p>
    </div>
    <div class="row mt-2">       
        ...
        <div class="input-box col-12">
            ...
            <textarea class="form-control" id="message" name="message" rows="1" value="<?php echo $message ?>" placeholder="Write Message" ></textarea>
        </div> 
